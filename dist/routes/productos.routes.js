...
class Productos {
    ...
    routes() {
         ...
         *     }
         */
        this.router.get("/", productos_controller_1.getProductosAllController);
        /**
         ...
         *     }
         */
        this.router.get("/:id", productos_controller_1.getProductosController);
        /**
         ...
         *     }
         */
        this.router.post("/", productos_controller_1.createProductosController);
        /**
         ...
         *     }
         */
        this.router.put("/:id", productos_controller_1.updateProductosController);
        /**
         ...
         *     }
         */
        this.router.delete("/:id", productos_controller_1.deleteProductosController);
    }
}
const productos = new Productos();
exports.default = productos.router;
